  ...
  return (
    <div className=" flex  justify-center text-center align-middle my-5 items-center mt-64 text-xl">
      <div className="justify-center text-center  align-middle p-8 bg-zinc-300 border border-black ">
        ...
        <div className=" flex">
          <strong> Email : </strong>
          <h4>{empdetails.email}</h4>
        </div>
        <div className="flex">
          <strong>Phone : </strong>
          <h4>{empdetails.phone}</h4>
        </div>
        <div className="flex">
          <strong>Salary : </strong>
          <h4>{empdetails.salary}</h4>
        </div>
        <div className="flex">
          <strong>Department : </strong>
          <h4>{empdetails.department}</h4>
        </div>
        <div></div>
        <button
          className="bg-blue-500 px-1  m-1 text-xl font-semibold rounded-md"
